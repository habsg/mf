...
# --- Flask App Setup --# Flask app setup - templates/static are now in the parent directory
app = Flask(__name__,
            template_folder='../templates',
            static_folder='../static')pathp.secret_key = secrets.token_hex(16) # For session management
